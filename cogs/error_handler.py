...
class ErrorHandler(commands.Cog):
    ...
    async def on_slash_command_error(self, inter: disnake.ApplicationCommandInteraction, error):
        if isinstance(error, MissingRole):
            return await inter.send(embed=disnake.Embed(title='У Вас недостаточно прав.', description='Вам нужно '
            ...
            return await inter.send(embed=disnake.Embed(title='У Вас недостаточно прав.', description='Вам нужно быть '
